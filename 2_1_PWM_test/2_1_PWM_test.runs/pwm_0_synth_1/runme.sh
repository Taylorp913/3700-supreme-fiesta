...
HD_PWD='/home/taylor/ECE_3700/3700-supreme-fiesta/2_1_PWM_test/2_1_PWM_test.runs/pwm_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log pwm_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source pwm_0.tcl
