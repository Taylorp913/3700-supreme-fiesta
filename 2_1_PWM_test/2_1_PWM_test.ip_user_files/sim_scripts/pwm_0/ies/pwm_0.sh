...
#
# Generated by Vivado on Wed Apr 18 15:45:25 MDT 2018
...
# Script info
echo -e "pwm_0.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./pwm_0.sh -help\" for more information)\n"
  exit 1
fi
...
compile()
{
  ...
  ncvlog -work xil_defaultlib $opts_ver \
    "$ref_dir/../../../../2_1_PWM_test.srcs/sources_1/ip/pwm_0/pwm.v" \
    "$ref_dir/../../../../2_1_PWM_test.srcs/sources_1/ip/pwm_0/sim/pwm_0.v" \
...
elaborate()
{
  ...
  ncelab $opts xil_defaultlib.pwm_0 xil_defaultlib.glbl $libs
}
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.pwm_0 -input simulate.do
}
# Script usage
usage()
{
