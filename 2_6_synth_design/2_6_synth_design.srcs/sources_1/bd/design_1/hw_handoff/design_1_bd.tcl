...
CONFIG.USE_RESET {false} \
  ...
  # Create instance: deltasigma_0, and set properties
  set deltasigma_0 [ create_bd_cell -type ip -vlnv user.org:user:deltasigma:1.0 deltasigma_0 ]
...
CONFIG.C_SIZE {1} \
  ...
  set wavetable_0 [ create_bd_cell -type ip -vlnv user.org:user:wavetable:1.0 wavetable_0 ]
...
CONFIG.DOUT_WIDTH {16} \
  ...
  connect_bd_net -net Net [get_bd_ports sw] [get_bd_pins xlslice_0/Din] [get_bd_pins xlslice_1/Din]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins deltasigma_0/clk]
  ...
  connect_bd_net -net deltasigma_0_dout [get_bd_ports sout] [get_bd_pins deltasigma_0/dout]
  ...
  connect_bd_net -net xlslice_0_Dout [get_bd_pins c_shift_ram_1/D] [get_bd_pins c_shift_ram_2/D] [get_bd_pins xlslice_0/Dout]
  connect_bd_net -net xlslice_1_Dout [get_bd_pins c_shift_ram_0/D] [get_bd_pins xlslice_1/Dout]
  connect_bd_net -net xlslice_2_Dout [get_bd_pins deltasigma_0/sample] [get_bd_pins xlslice_2/Dout]
...
preplace port sout -pg 1 -y 270 -defaultsOSRD
preplace port btnU -pg 1 -y 260 -defaultsOSRD
preplace portBus sw -pg 1 -y 110 -defaultsOSRD
preplace portBus shutdown_l -pg 1 -y 550 -defaultsOSRD
preplace portBus gain -pg 1 -y 530 -defaultsOSRD
preplace inst xlslice_0 -pg 1 -lvl 3 -y 150 -defaultsOSRD
preplace inst xlconstant_0 -pg 1 -lvl 4 -y 540 -defaultsOSRD
preplace inst xlslice_1 -pg 1 -lvl 1 -y 110 -defaultsOSRD
preplace inst xlslice_2 -pg 1 -lvl 6 -y 320 -defaultsOSRD
preplace inst util_vector_logic_0 -pg 1 -lvl 3 -y 60 -defaultsOSRD
preplace inst c_counter_binary_0 -pg 1 -lvl 4 -y 410 -defaultsOSRD
preplace inst deltasigma_0 -pg 1 -lvl 7 -y 270 -defaultsOSRD
preplace inst wavetable_0 -pg 1 -lvl 5 -y 320 -defaultsOSRD
preplace inst c_shift_ram_0 -pg 1 -lvl 2 -y 120 -defaultsOSRD
preplace inst c_shift_ram_1 -pg 1 -lvl 4 -y 10 -defaultsOSRD
preplace inst clk_wiz_0 -pg 1 -lvl 1 -y 240 -defaultsOSRD
preplace inst c_shift_ram_2 -pg 1 -lvl 4 -y 150 -defaultsOSRD
preplace inst c_shift_ram_3 -pg 1 -lvl 4 -y 300 -defaultsOSRD
preplace netloc c_shift_ram_1_Q 1 4 1 890
preplace netloc xlslice_1_Dout 1 1 1 NJ
preplace netloc btnU_1 1 0 4 NJ 300 NJ 290 NJ 290 NJ
preplace netloc wavetable_0_dout 1 5 1 N
preplace netloc util_vector_logic_0_Res 1 3 1 660
preplace netloc sys_clock_1 1 0 1 -20
preplace netloc c_shift_ram_3_Q 1 4 1 N
preplace netloc c_shift_ram_2_Q 1 4 1 880
preplace netloc deltasigma_0_dout 1 7 1 N
preplace netloc xlconstant_0_dout 1 4 4 900 530 NJ 530 NJ 530 1520
preplace netloc clk_wiz_0_clk_out1 1 1 6 NJ 230 NJ 230 NJ 230 NJ 230 NJ 230 1330
preplace netloc xlslice_2_Dout 1 6 1 1330
preplace netloc clk_wiz_0_clk_out2 1 1 3 190 -10 NJ -10 640
preplace netloc Net 1 0 3 -20 60 NJ 60 NJ
preplace netloc c_counter_binary_0_THRESH0 1 4 1 870
preplace netloc c_shift_ram_0_Q 1 2 2 430 10 630
preplace netloc xlslice_0_Dout 1 3 1 650
levelinfo -pg 1 -40 90 320 530 770 1020 1230 1430 1540 -top -60 -bot 710
",
}
