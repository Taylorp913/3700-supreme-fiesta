...
reset_run()
{
  files_to_remove=(ucli.key ublaze_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log 64 AN.DB csrc ublaze_simv.daidir)
...
elaborate()
{
  ...
  vcs $opts xil_defaultlib.ublaze xil_defaultlib.glbl -o ublaze_simv
}
...
simulate()
{
  ...
  ./ublaze_simv $opts -do simulate.do
}
# Script usage
usage()
{
