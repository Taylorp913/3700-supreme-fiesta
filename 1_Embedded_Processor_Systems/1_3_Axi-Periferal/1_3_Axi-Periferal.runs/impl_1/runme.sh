...
HD_PWD='C:/ECE_3700/3700-supreme-fiesta/1_Embedded_Processor_Systems/1_3_Axi-Periferal/1_3_Axi-Periferal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegment_wrapper.vdi -applog -m64 -messageDb vivado.pb -mode batch -source SevenSegment_wrapper.tcl -notrace
