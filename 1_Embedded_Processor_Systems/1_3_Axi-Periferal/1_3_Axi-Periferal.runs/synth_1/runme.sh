...
HD_PWD='C:/ECE_3700/3700-supreme-fiesta/1_Embedded_Processor_Systems/1_3_Axi-Periferal/1_3_Axi-Periferal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SevenSegment_wrapper.vds -m64 -mode batch -messageDb vivado.pb -notrace -source SevenSegment_wrapper.tcl
