...
#
# Generated by Vivado on Sat Mar 24 15:27:45 -0600 2018
# IP Build 1412160 on Tue Nov 17 13:47:24 MST 2015 
#
# usage: ublaze.sh [-help]
# usage: ublaze.sh [-lib_map_path]
# usage: ublaze.sh [-noclean_files]
# usage: ublaze.sh [-reset_run]
#
...
# executing this script. Please type 'ublaze.sh -help' for more information.
#
...
# Script info
echo -e "ublaze.sh - Script generated by export_simulation (Vivado v2015.4 (64-bit)-id)\n"

# Script usage
usage()
{
  msg="Usage: ublaze.sh [-help]\n\
Usage: ublaze.sh [-lib_map_path]\n\
Usage: ublaze.sh [-reset_run]\n\
Usage: ublaze.sh [-noclean_files]\n\n\
...
if [[ ($# == 1 ) && ($1 != "-lib_map_path" && $1 != "-noclean_files" && $1 != "-reset_run" && $1 != "-help" && $1 != "-h") ]]; then
  echo -e "ERROR: Unknown option specified '$1' (type \"./ublaze.sh -help\" for more information)\n"
  exit 1
fi
...
setup()
{
  case $1 in
    "-lib_map_path" )
      if [[ ($2 == "") ]]; then
        echo -e "ERROR: Simulation library directory path not specified (type \"./ublaze.sh -help\" for more information)\n"
        exit 1
      fi
...
create_lib_mappings()
{
  libs=(microblaze_v9_5_3 xil_defaultlib lmb_v10_v3_0_7 lmb_bram_if_cntlr_v4_0_7 blk_mem_gen_v8_3_1 axi_lite_ipif_v3_0_3 mdm_v3_2_4 lib_cdc_v1_0_2 proc_sys_reset_v5_0_8 lib_pkg_v1_0_2 lib_srl_fifo_v1_0_2 axi_uartlite_v2_0_10 axi_timer_v2_0_8 generic_baseblocks_v2_1_0 axi_infrastructure_v1_1_0 axi_register_slice_v2_1_7 fifo_generator_v13_0_1 axi_data_fifo_v2_1_6 axi_crossbar_v2_1_8 interrupt_control_v3_1_3 axi_gpio_v2_0_9)
  file="cds.lib"
  dir="ies"
...
compile()
{
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_microblaze_0_0/sim/ublaze_microblaze_0_0.vhd" \

  ncvhdl -work lmb_v10_v3_0_7 $opts_vhd \
    "$ref_dir/../../../ipstatic/lmb_v10_v3_0/hdl/vhdl/lmb_v10.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_dlmb_v10_0/sim/ublaze_dlmb_v10_0.vhd" \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_ilmb_v10_0/sim/ublaze_ilmb_v10_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_dlmb_bram_if_cntlr_0/sim/ublaze_dlmb_bram_if_cntlr_0.vhd" \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_ilmb_bram_if_cntlr_0/sim/ublaze_ilmb_bram_if_cntlr_0.vhd" \

  ncvhdl -work blk_mem_gen_v8_3_1 $opts_vhd \
    "$ref_dir/../../../ipstatic/blk_mem_gen_v8_3/simulation/blk_mem_gen_v8_3.vhd" \

  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_lmb_bram_0/sim/ublaze_lmb_bram_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_mdm_1_0/sim/ublaze_mdm_1_0.vhd" \

  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_clk_wiz_1_0/ublaze_clk_wiz_1_0_clk_wiz.v" \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_clk_wiz_1_0/ublaze_clk_wiz_1_0.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_rst_clk_wiz_1_100M_0/sim/ublaze_rst_clk_wiz_1_100M_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_axi_uartlite_0_0/sim/ublaze_axi_uartlite_0_0.vhd" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_axi_timer_0_0/sim/ublaze_axi_timer_0_0.vhd" \
  ...
  ncvlog -work xil_defaultlib $opts_ver +incdir+"$ref_dir/../../../ipstatic/axi_infrastructure_v1_1/hdl/verilog" \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_xbar_0/sim/ublaze_xbar_0.v" \
    "$ref_dir/../../../bd/ublaze/hdl/ublaze.v" \
  ...
  ncvhdl -work xil_defaultlib $opts_vhd \
    "$ref_dir/../../../bd/ublaze/ip/ublaze_axi_gpio_0_0/sim/ublaze_axi_gpio_0_0.vhd" \
...
simulate()
{
  ...
  ncsim $opts xil_defaultlib.ublaze -input simulate.do
}
# Script usage
usage()
{
