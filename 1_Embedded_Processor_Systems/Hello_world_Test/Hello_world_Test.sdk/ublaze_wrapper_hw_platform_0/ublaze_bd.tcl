...
CONFIG.USE_BOARD_FLOW {true} \
  ...
  connect_bd_net -net rst_clk_wiz_1_100M_peripheral_aresetn [get_bd_pins axi_timer_0/s_axi_aresetn] [get_bd_pins axi_uartlite_0/s_axi_aresetn] [get_bd_pins microblaze_0_axi_periph/M00_ARESETN] [get_bd_pins microblaze_0_axi_periph/M01_ARESETN] [get_bd_pins microblaze_0_axi_periph/S00_ARESETN] [get_bd_pins rst_clk_wiz_1_100M/peripheral_aresetn]
...
#  -string -flagsOSRD
preplace port sys_clock -pg 1 -y 150 -defaultsOSRD
...
preplace inst axi_timer_0 -pg 1 -lvl 5 -y 160 -defaultsOSRD
...
preplace inst clk_wiz_1 -pg 1 -lvl 1 -y 150 -defaultsOSRD
preplace inst microblaze_0_local_memory -pg 1 -lvl 4 -y 80 -defaultsOSRD
preplace netloc microblaze_0_Clk 1 1 4 180 310 530 150 1000 160 1310
...
preplace netloc rst_clk_wiz_1_100M_interconnect_aresetn 1 2 2 NJ 240 990
...
preplace netloc rst_clk_wiz_1_100M_peripheral_aresetn 1 2 3 NJ 260 980 440 1320
...
preplace netloc reset_1 1 0 2 NJ 200 NJ
preplace netloc mdm_1_debug_sys_rst 1 1 2 190 130 510
levelinfo -pg 1 0 100 350 760 1150 1430 1560 -top 0 -bot 450
",
}
