...
(* CORE_GENERATION_INFO = "ublaze,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=ublaze,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=17,numReposBlks=12,numNonXlnxBlks=0,numHierBlks=5,maxHierDepth=1,da_axi4_cnt=2,da_board_cnt=3,da_mb_cnt=1,synth_mode=Global}" *) (* HW_HANDOFF = "ublaze.hwdef" *) 
module ublaze
   (reset,
    sys_clock,
    usb_uart_rxd,
