...
CONFIG.PHASE {0.000} \
  ...
  set AXI_SevenSegmentDriver_0 [ create_bd_cell -type ip -vlnv usu.edu:user:AXI_SevenSegmentDriver:2.0 AXI_SevenSegmentDriver_0 ]
...
preplace portBus sw -pg 1 -y 260 -defaultsOSRD -right
...
preplace inst AXI_SevenSegmentDriver_0 -pg 1 -lvl 5 -y 90 -defaultsOSRD
