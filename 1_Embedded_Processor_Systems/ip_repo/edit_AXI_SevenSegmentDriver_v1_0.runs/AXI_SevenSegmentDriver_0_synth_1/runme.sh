...
HD_PWD='c:/ece_3700/3700-supreme-fiesta/1_embedded_processor_systems/ip_repo/edit_AXI_SevenSegmentDriver_v1_0.runs/AXI_SevenSegmentDriver_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log AXI_SevenSegmentDriver_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source AXI_SevenSegmentDriver_0.tcl
